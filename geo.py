...
class OAMonitorUnpaywallByCountry(db.Model, GeoRowMixin):
    ...
    num_distinct_articles = db.Column(db.Numeric(asdecimal=False))
    is_oa = deferred(db.Column(db.Numeric(asdecimal=False)))
    bronze = deferred(db.Column(db.Numeric(asdecimal=False)))
    green = deferred(db.Column(db.Numeric(asdecimal=False)))
    gold = deferred(db.Column(db.Numeric(asdecimal=False)))
    hybrid = deferred(db.Column(db.Numeric(asdecimal=False)))
    bronze_green = deferred(db.Column(db.Numeric(asdecimal=False)))
    bronze_gold = deferred(db.Column(db.Numeric(asdecimal=False)))
    bronze_hybrid = deferred(db.Column(db.Numeric(asdecimal=False)))
    green_gold = deferred(db.Column(db.Numeric(asdecimal=False)))
    green_hybrid = deferred(db.Column(db.Numeric(asdecimal=False)))
    gold_hybrid = deferred(db.Column(db.Numeric(asdecimal=False)))
    bronze_green_gold = deferred(db.Column(db.Numeric(asdecimal=False)))
    bronze_green_hybrid = deferred(db.Column(db.Numeric(asdecimal=False)))
    bronze_gold_hybrid = deferred(db.Column(db.Numeric(asdecimal=False)))
    green_gold_hybrid = deferred(db.Column(db.Numeric(asdecimal=False)))
